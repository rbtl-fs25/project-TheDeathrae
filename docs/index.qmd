...
@fig-encouragement shows that there is potential to increase the willingness to take leftovers home when eating in university cafeterias and thus reduce food waste. Most students reported that having either their own reusable containers or having access to such would make them more likely to take leftovers home. This may reflect that while reusable containers are widely available at ETH Zurich cafeterias, the system is not implemented in a way that encourages use for leftovers or that knowledge of its existence is not widespread.
...
-   Students report high levels of consciousness of food waste, with the vast majority considering sustainability as a motivation
