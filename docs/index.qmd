...
```{r}
data <- read_csv(here::here("data/processed/university-lunch-food-waste_processed.csv"))

data |> 
  summarise(consciousness, motivation_sustainability, motivation_monetary, motivation_humanitarian, motivation_cultural)
```
